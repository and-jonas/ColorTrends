...
workdir = 'C:/Users/anjonas/PycharmProjects/WheatSegmentationModels'
dir_patch_coordinates = f'{workdir}/data/Inference/coordinates'
dir_ear_mask = f'{workdir}/output/SegEar/Mask'
dir_veg_mask = f'{workdir}/output/SegVeg/Mask'
out_dir = workdir

files = [f'{workdir}/data/Inference/images/20220623_Cam_ESWW0060132_Cnp_1.JPG']
...
img = imageio.imread("Z:/Public/Jonas/003_ESWW/Manuscript/Figures/Figure1/ESWW2204_202207061_mask.png")
...
imageio.imwrite("Z:/Public/Jonas/003_ESWW/Manuscript/Figures/Figure1/ESWW2204_202207061_mask_inv.JPG", img_inv)