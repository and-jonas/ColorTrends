...
# # ======================================================================================================================
#
# paths = glob.glob("Z:/Public/Jonas/Data/ESWW006/Images_trainset/*/JPEG/ESWW*.JPG")
...
#         if not os.path.exists(checker_name):
#             pass
#         else:
#             continue
#
...
#         lower = np.array([95, 150, 22])  # v changed successively from 35 to 30 to 22 for selected images
...
# check_dir = Path(out_dir) / "Checker"
...
# paths = glob.glob("Z:/Public/Jonas/Data/ESWW006/Images_trainset/*/JPEG/*.JPG")
# parent_dir = Path("Z:/Public/Jonas/Data/ESWW006/Images_trainset")
# meas_events = [x for x in os.listdir(parent_dir) if x.startswith("2022_")][2:]
#
# # loop over measurement events
# for event in meas_events:
#
